...
2. Go to a directory you can put temp install files (eg. `cd ~/Downloads`)
3. Run `git clone https://github.com/diegocabello/sculblog.git` to clone the repo 
    - Later the repo will also hosted on sculblog.org
4. Install your server of choice (apache2, nginx) with `sudo apt install apache2` or `sudo apt install nginx`
